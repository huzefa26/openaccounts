...
description: >
  UI/UX design system and component guide for OpenAccounts — a minimalist personal
  double-entry accounting web app. Use this skill whenever building, designing, or
  iterating on any part of the OpenAccounts interface: the home dashboard, data entry
...
# OpenAccounts — UI/UX Design Skill
...
OpenAccounts occupies the intersection of three inspirations:
