export const baseCoa = [
  ...
  { name: 'Accounts Receivable', type: 'asset', parent: null, description: 'People who owe you money. Create a sub-category for each person.' },
  ...
  { name: 'Accounts Payable', type: 'liability', parent: null, description: 'People you owe money to. Create a sub-category for each person.' },
